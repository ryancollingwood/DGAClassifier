...
from src.features import count_character_pairs_in_column_as_df


class CountCharacterPairsTransformer(DataFrameColumnTransformer):
    ...
    def _transform(self, series: pd.Series, y: np.ndarray = None):
        result = count_character_pairs_in_column_as_df(
            series,
